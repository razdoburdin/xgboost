 ...
 protected:
  ...
  struct Builder {
   ...
   protected:
    ...
    HistCollectionOneAPI<GradientSumT, MemoryType::on_device> hist_;
    /*! \brief culmulative local parent histogram of gradients. */
    HistCollectionOneAPI<GradientSumT, MemoryType::on_device> hist_local_worker_;
    ...
    std::array<common::ParallelGHistBuilderOneAPI<GradientSumT>, kNumParallelBuffers> hist_buffers_;
