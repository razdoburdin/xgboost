...
using GHistRowOneAPI = USMVector<xgboost::detail::GradientPairInternal<GradientSumT>, memory_type>;
...
void InitHist(sycl::queue qu,
              GHistRowOneAPI<GradientSumT, MemoryType::on_device>& hist,
              size_t size);
...
class HistCollectionOneAPI {
 public:
  using GHistRowT = GHistRowOneAPI<GradientSumT, memory_type>;
...
class ParallelGHistBuilderOneAPI {
 public:
  using GHistRowT = GHistRowOneAPI<GradientSumT, MemoryType::on_device>;
...
class GHistBuilderOneAPI {
 public:
  ...
  sycl::event BuildHist(const USMVector<GradientPair, MemoryType::on_device>& gpair_device,
                        ...
                        GHistRowT<MemoryType::on_device>& HistCollectionOneAPI,
                        bool isDense,
