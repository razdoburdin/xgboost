...
class HistogramBuilder {
 ...
 public:
  ...
  template <bool any_missing, bool is_root, typename PartitionType>
  void
  ...
  template <bool is_root, typename PartitionType>
...
template <typename ExpandEntry>
class HistogramBuilderForApprox {
  /*! \brief culmulative histogram of gradients. */
  common::HistCollection hist_;
  /*! \brief culmulative local parent histogram of gradients. */
  common::HistCollection hist_local_worker_;
  common::GHistBuilder builder_;
  common::ParallelGHistBuilderForApprox buffer_;
  BatchParam param_;
