...
/* ColumnSplit */
// TEST(SyclPredictor, IterationRangeColmnSplit) {
//   Context ctx;
//   ctx.UpdateAllowUnknown(Args{{"device", "sycl"}});
...
/* Categorial features */
// TEST(SyclPredictor, CategoricalPrediction) {
//   Context ctx;
//   ctx.UpdateAllowUnknown(Args{{"device", "sycl"}});
...
/* ColumnSplit */
/* Categorial features */
// TEST(SyclPredictor, CategoricalPredictionColumnSplit) {
//   Context ctx;
//   ctx.UpdateAllowUnknown(Args{{"device", "sycl"}});
...
TEST(SyclPredictor, CategoricalPredictLeafColumnSplit) {
  Context ctx;
  ctx.UpdateAllowUnknown(Args{{"device", "sycl"}});;
...
TEST(SyclPredictor, LesserFeaturesColumnSplit) {
  Context ctx;
  ctx.UpdateAllowUnknown(Args{{"device", "sycl"}});
...
/* ColumnSplit */
// TEST(SyclPredictor, SparseColumnSplit) {
//   Context ctx;
//   ctx.UpdateAllowUnknown(Args{{"device", "sycl"}});
